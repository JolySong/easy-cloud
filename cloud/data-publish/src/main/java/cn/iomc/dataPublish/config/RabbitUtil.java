...
//                    .to(new DirectExchange(exchangeName)).with(routingKey);
//        }
//        if(ExchangeType.TOPIC.equals(exchangeType)){
//            return BindingBuilder.bind(new Queue(queueName))
//                    .to(new TopicExchange(exchangeName)).with(routingKey);
//        }
//        if(ExchangeType.HEADERS.equals(exchangeType)){
//            if(isWhereAll){
//                return BindingBuilder.bind(new Queue(queueName))
//                        .to(new HeadersExchange(exchangeName)).whereAll(headers).match();
//            }else{
//                return BindingBuilder.bind(new Queue(queueName))
//                        .to(new HeadersExchange(exchangeName)).whereAny(headers).match();
//            }
//        }
//        if(ExchangeType.FANOUT.equals(exchangeType)){
